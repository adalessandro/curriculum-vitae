...
degree in 2017, with a degree thesis on SLAM system.
...
Robotic startup company. During this project, worked as one of the first
...
cosmic, STM32 libopencm3, unicore-mx
(\href{https://github.com/insane-adding-machines/unicore-mx-examples/commits?author=adalessandro}{contributions}),
ESP32 esp-idf.
\begin{itemize}
...
% Job entry
\item [July 2015 - June 2017] \emph{Software Engineer} -
...
(\href{https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/log/?qt=author&q=Ariel+D.*Alessandro}{contributions}),
...
Code released as a \href{http://www.ros.org}{ROS} package under GPLv3 license:
